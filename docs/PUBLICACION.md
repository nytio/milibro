...
- Fuentes embebidas: verifica con `pdffonts dist/<libro>.pdf` (si está disponible).
...
- Metadatos básicos (pandoc fallback): edita `tex/books/<libro>/metadata.yaml` (o usa `tex/metadata.yaml` como plantilla).
