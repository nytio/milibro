...
% Activa en tex/metadatos.tex: \newcommand{\LibroUsarBibliografia}{1}
% Crea tu fichero: tex/referencias.bib
\ifnum\LibroUsarBibliografia=1\relax
  \IfFileExists{tex/referencias.bib}{%
    \usepackage{csquotes}
    \usepackage[backend=biber,style=authoryear,sorting=nyt]{biblatex}
    \addbibresource{tex/referencias.bib}
    \DefineBibliographyStrings{spanish}{bibliography={Bibliografía}}
  }{%
    \typeout{milibro: \string\\LibroUsarBibliografia=1 pero falta tex/referencias.bib}%
  }%
\fi
